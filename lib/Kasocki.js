...
//     }
     ...
     * TODO: start should probably call the client socket ack callback once
     * once the loop has started.  This is hard to do from here, since
     * the handlerWrapper expects on_ handlers to return there ack
     * callback result.  HmmmMmmM.
     */
    on_start() {
        // Already running
        if (this.running) {
